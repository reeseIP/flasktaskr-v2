...
class TaskTests(unittest.TestCase):
    ...
    def test_task_template_diplays_logged_in_user_name(self):
        self.register('Fletcher','fletcher@realpython.com','python101','python101')
        self.login('Fletcher','python101')
    ...
    def test_logged_in_users_can_access_tasks_page(self):
        self.register('Fletcher', 'fletcher@fl.org', 'pythonpass01', 'pythonpass01')
        self.login('Fletcher', 'pythonpass01')
    ...
    def test_users_can_add_tasks(self):
        self.create_user('James', 'johnjames@jj.org', 'sneakypass01')
        self.login('James', 'sneakypass01')
        self.app.get('tasks/',follow_redirects=True)
        response = self.create_task()
    ...
    def test_users_cannot_delete_tasks_that_are_not_created_by_them(self):
        self.create_user('Michael', 'michael@realpython.com', 'python01')
        self.login('Michael', 'python01')
        self.app.get('tasks/', follow_redirects=True)
        self.create_task()
        self.logout()
